...
subtitle: "A Signal-Class Architecture of Differential Psychological Resolution"
...
> "My partner is distant, but may simply be stressed. I notice my anxiety but can hold uncertainty."
...
Example:
- Baseline shame resolution: Moderate (5/8)
- Stress shame resolution: Very low (1/8)
- Resolution retention: 1/5 = 20%
...
Mentalization (Fonagy et al., 2002) describes the capacity to understand behavior in terms of mental states. The present framework proposes that mentalization capacity may itself be signal-class-dependent — a person may mentalize effectively regarding others' professional motivations while failing to mentalize regarding attachment-relevant intentions. This is consistent with Fonagy's observation that mentalization degrades under attachment activation, but extends it to a broader signal-class architecture.
...
The critical distinction from all of the above is architectural specificity. Existing frameworks typically describe either:
